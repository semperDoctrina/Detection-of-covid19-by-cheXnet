...
from tqdm import tqdm
                                ...
                                # modified these two functions, so that can later also read the inception tensors which 
...
def show_history_graph(history):
    ...
    plt.show() 
                                               ...
                                               # callback to show the total time taken during training and for each epochsssssssssssss done 
...
model.save('trained_modelDNN1.h5')
